...
public class GraphicOverlays<T extends GraphicOverlays.Graphic> extends View {
    private final Object mLock = new Object();
    private int mPreviewWidth;
    private float mWidthScaleFactor = 1.0f;
    private int mPreviewHeight;
    private float mHeightScaleFactor = 1.0f;
    private int mFacing = CameraSources.CAMERA_FACING_BACK;
    ...
    public static abstract class Graphic {
        private GraphicOverlays mOverlay;

        public Graphic(GraphicOverlays overlay) {
            mOverlay = overlay;
        }
        ...
        public float translateX(float x) {
            if (mOverlay.mFacing == CameraSources.CAMERA_FACING_FRONT) {
    ...
    public GraphicOverlays(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
