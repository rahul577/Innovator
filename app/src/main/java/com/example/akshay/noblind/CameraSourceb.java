...
public class CameraSourceb {
    ...
    public static class Builder {
        ...
        private CameraSourceb mCameraSource = new CameraSourceb();
    ...
    public CameraSourceb start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSourceb start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
